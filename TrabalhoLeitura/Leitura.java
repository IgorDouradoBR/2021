...
public class Leitura {
    ...
    public static void main(String[] args) {
        ...
        int numLinhas = 0;
        int numPaginas = 1;
        DoubleLinkedListOfString stopw = new DoubleLinkedListOfString();
        DoubleLinkedListOfPalavra palavras = new DoubleLinkedListOfPalavra();
        ...
        Scanner teclado2 = new Scanner(System.in);//O teclado 1 nao tava lendo o item 4    
            ...
            while(true){
                ...
                switch(opcao){
                    case 1:
                        Palavra[] emVetor = new Palavra[(int)palavras.size()];
                    ...
                    case 4:
                        ...
                        for(int i=0; i<palavras.size(); i++){
                            if(palavras.get(i).getPalavra().equals(palavra.toLowerCase())){
                                System.out.println("Paginas que contêm a palavra "+ palavra + ": "+ palavras.get(i).getPaginasOcorre().toString()+ "\n qual o número da página você quer exibir?");
                                Integer qualPagina = teclado.nextInt();
                                if(palavras.get(i).getPaginasOcorre().contains(qualPagina)){
